# All in One Accessibility®: Chamilo Plugin
...
Step 1: Download Chamilo plugin from GIT in ZIP formate or clone the plugin code, here is the link for GIT repository:
            URL: https://github.com/skynettechnologies/chamilo-allinoneaccessibility
Step 2: Make a zip file of code if not downloaded ZIP formate from GIT
Step 3: Upload ZIP file into Chamilo's plugin page (Administration >> Plugin >> Upload Plugin tab)
Step 4: After upload plugin, you can see the All in One Accessibility plugin in list, just check it, and click on "Enable the selected plugins" button
